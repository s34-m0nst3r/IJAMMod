...
import com.idtech.enchantment.RadiationAspectEnchantment;
...
//            event.getRegistry().register(BlockMod.CASTLE_WALL);
        ...
        public static void registerItems(final RegistryEvent.Register<Item> event) {
            ...
            // Register enchanted books in the desired creative tab
            for (int level = 1; level <= RadiationAspectEnchantment.INSTANCE.getMaxLevel(); level++) {
                ItemStack enchantedBook = EnchantedBookItem.createForEnchantment(new EnchantmentInstance(RadiationAspectEnchantment.INSTANCE, level));
                // Add the book to the custom creative tab
                //ModTab.INSTANCE.add(enchantedBook);
            }
